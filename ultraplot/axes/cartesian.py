...
class _AxisParams:
    ...
    def from_vars(cls, prefix, var_dict):
        return cls(
            min=var_dict.get(f"{prefix}min"),
            max=var_dict.get(f"{prefix}max"),
            lim=var_dict.get(f"{prefix}lim"),
            reverse=var_dict.get(f"{prefix}reverse"),
            margin=var_dict.get(f"{prefix}margin"),
            bounds=var_dict.get(f"{prefix}bounds"),
            tickrange=var_dict.get(f"{prefix}tickrange"),
            wraprange=var_dict.get(f"{prefix}wraprange"),
            scale=var_dict.get(f"{prefix}scale"),
            scale_kw=var_dict.get(f"{prefix}scale_kw"),
            spineloc=var_dict.get(f"{prefix}spineloc"),
            tickloc=var_dict.get(f"{prefix}tickloc"),
            ticklabelloc=var_dict.get(f"{prefix}ticklabelloc"),
            labelloc=var_dict.get(f"{prefix}labelloc"),
            offsetloc=var_dict.get(f"{prefix}offsetloc"),
            grid=var_dict.get(f"{prefix}grid"),
            gridminor=var_dict.get(f"{prefix}gridminor"),
            locator=var_dict.get(f"{prefix}locator"),
            locator_kw=var_dict.get(f"{prefix}locator_kw"),
            minorlocator=var_dict.get(f"{prefix}minorlocator"),
            minorlocator_kw=var_dict.get(f"{prefix}minorlocator_kw"),
            formatter=var_dict.get(f"{prefix}formatter"),
            formatter_kw=var_dict.get(f"{prefix}formatter_kw"),
            label=var_dict.get(f"{prefix}label"),
            label_kw=var_dict.get(f"{prefix}label_kw"),
            color=var_dict.get(f"{prefix}color"),
            gridcolor=var_dict.get(f"{prefix}gridcolor"),
            linewidth=var_dict.get(f"{prefix}linewidth"),
            rotation=var_dict.get(f"{prefix}rotation"),
            tickminor=var_dict.get(f"{prefix}tickminor"),
            tickdir=var_dict.get(f"{prefix}tickdir"),
            tickcolor=var_dict.get(f"{prefix}tickcolor"),
            ticklen=var_dict.get(f"{prefix}ticklen"),
            ticklenratio=var_dict.get(f"{prefix}ticklenratio"),
            tickwidth=var_dict.get(f"{prefix}tickwidth"),
            tickwidthratio=var_dict.get(f"{prefix}tickwidthratio"),
            ticklabeldir=var_dict.get(f"{prefix}ticklabeldir"),
            ticklabelpad=var_dict.get(f"{prefix}ticklabelpad"),
            ticklabelcolor=var_dict.get(f"{prefix}ticklabelcolor"),
            ticklabelsize=var_dict.get(f"{prefix}ticklabelsize"),
            ticklabelweight=var_dict.get(f"{prefix}ticklabelweight"),
            labelpad=var_dict.get(f"{prefix}labelpad"),
            labelcolor=var_dict.get(f"{prefix}labelcolor"),
            labelsize=var_dict.get(f"{prefix}labelsize"),
            labelweight=var_dict.get(f"{prefix}labelweight"),
        )
